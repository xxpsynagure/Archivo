...
class Registration(models.Model):
    usn_ssid = models.CharField(primary_key=True, max_length=10)
    ...
    pass_field = models.CharField(db_column='Pass', max_length=255)  # Field name made lowercase. Field renamed because it was a Python reserved word.
    branch = models.CharField(db_column='Branch', max_length=255, blank=True, null=True)  # Field name made lowercase.
    college = models.CharField(db_column='College', max_length=255)  # Field name made lowercase.
